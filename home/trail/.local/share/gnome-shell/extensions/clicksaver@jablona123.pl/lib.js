...
function getSettings(extension) {
    let schemaName = 'org.gnome.shell.extensions.clicksaver';
...
function initTranslations(extension) {
    ...
    if (GLib.file_test(localeDir, GLib.FileTest.EXISTS)) {
        Gettext.bindtextdomain('gnome-shell-extensions-clicksaver', localeDir);
    }
    // Extension installed system-wide
    else {
        Gettext.bindtextdomain('gnome-shell-extensions-clicksaver', extension.metadata.locale);
    }
}
