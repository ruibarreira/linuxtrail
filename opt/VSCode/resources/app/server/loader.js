...
(function (AMDLoader) {
        ...
        ModuleIdResolver.prototype.resolveModule = function (moduleId) {
            ...
            if (!Utilities.isAbsolutePath(result)) {
                if (Utilities.startsWith(result, './') || Utilities.startsWith(result, '../')) {
                    result = this._normalizeModuleId(this.fromModulePath + result);
                }
            }
            return result;
        };
    ...
    // Module
    var Module = (function () {
        function Module(id, dependencies, callback, errorback, moduleIdResolver, config) {
            this._id = id;
    ...
    var ModuleManager = (function () {
        ...
        ModuleManager.prototype.enqueueDefineModule = function (id, dependencies, callback) {
            if (this._loadingScriptsCount === 0) {
                ...
                this.defineModule(id, dependencies, callback, null);
            }
            else {
        ...
        ModuleManager.prototype.defineModule = function (id, dependencies, callback, errorback, moduleIdResolver) {
            ...
            var m = new Module(id, dependencies, callback, errorback, moduleIdResolver, moduleConfig);
            this._modules[id] = m;
        ...
        ModuleManager.prototype._onLoad = function (id) {
            ...
            if (this._config.isShimmed(id)) {
                ...
                this.defineModule(id, defineCall.dependencies, defineCall.callback, null);
            }
            else {
        ...
        ModuleManager.prototype._resolveShimmedDependency = function (moduleId, dependencyId, loadCallback) {
            ...
            if (defineInfo.dependencies.length > 0) {
                this.defineModule(Utilities.generateAnonymousModule(), defineInfo.dependencies, function () { return loadCallback(dependencyId); }, null, new ModuleIdResolver(this._config, dependencyId));
            }
            else {
        ...
        ModuleManager.prototype._loadModule = function (anyModuleIdResolver, moduleId) {
            ...
            var loadNextPath = function (err) {
                ...
                if (lastPathIndex >= paths.length) {
                    ...
                    _this._scriptLoader.load(paths[lastPathIndex], function () { return _this._onLoad(moduleId); }, loadNextPath);
                }
            };
            loadNextPath(null);
        };
    ...
    var OnlyOnceScriptLoader = (function () {
        ...
        OnlyOnceScriptLoader.prototype.load = function (scriptSrc, callback, errorback) {
            var _this = this;
            var scriptCallbacks = {
                callback: callback,
                errorback: errorback
            ...
            this.actualScriptLoader.load(scriptSrc, function () { return _this.triggerCallback(scriptSrc); }, function (err) { return _this.triggerErrorback(scriptSrc, err); });
        };
    ...
    var NodeScriptLoader = (function () {
        ...
        NodeScriptLoader.prototype.load = function (scriptSrc, callback, errorback) {
            var _this = this;
            ...
            if (/^node\|/.test(scriptSrc)) {
                ...
                if (/^file:\/\//.test(scriptSrc)) {
                    scriptSrc = scriptSrc.substr(7);
                }
                this._fs.readFile(scriptSrc, { encoding: 'utf8' }, function (err, data) {
                    ...
                    if (isAtomShell) {
                        ...
                        vmScriptSrc = 'file:///_MAIN:' + vmScriptSrc.replace(/\\/g, '/');
                    }
                    ...
                    var r = _this._vm.runInThisContext(contents, vmScriptSrc, true);
    ...
    var global = _amdLoaderGlobal, isWebWorker, isAtomShell, isNode, scriptLoader, moduleManager;
    function initVars() {
        isWebWorker = (typeof global.importScripts === 'function');
        isAtomShell = (typeof process !== 'undefined' && typeof process.versions !== 'undefined' && typeof process.versions['atom-shell'] !== 'undefined');
