...
// This is a tailored copy of the WinJS.js file for the node server.
...
/*
	...
	Changes:
		...
		- we have to define msSetImmediate and setImmediate if not running in IE 10 since its a IE 10 only function
		- we have removed some getter syntax
*/

// MONACO CHANGE: define msSetImmediate & setImmediate
var msSetImmediate, setImmediate;
msSetImmediate = setImmediate = function (callback) {
...
(function() {
    ...
    var myExports = {
        Class: ns.WinJS.Class,
        Promise: ns.WinJS.Promise,
        TPromise: ns.WinJS.Promise,
        PPromise: ns.WinJS.Promise
    };
