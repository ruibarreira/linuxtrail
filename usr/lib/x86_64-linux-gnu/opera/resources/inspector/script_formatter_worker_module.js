...
return tokenize;}};var FormatterParameters;self.onmessage=function(event){var data=(event.data);if(!data.method)
...
{this._expect(FormatterWorker.JavaScriptTokens.FUNCTION);this._builder.addSpace();if(this._peek()===FormatterWorker.JavaScriptTokens.MUL)
this._next();this._expect(FormatterWorker.JavaScriptTokens.IDENTIFIER);this._parseFunctionLiteral();},_parseBlock:function()
