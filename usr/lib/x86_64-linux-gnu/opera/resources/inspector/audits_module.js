...
{return WebInspector.linkifyResourceAsNode(url,line,"resource-url webkit-html-resource-link");}};WebInspector.AuditFormatters.prototype={apply:function(value)
...
{WebInspector.SidebarPane.call(this,categoryResult.title);this._treeOutline=new TreeOutlineInShadow();this._treeOutline.element.classList.add("audit-result-tree");this.bodyElement.appendChild(this._treeOutline.element);this._treeOutline.expandTreeElementsWhenArrowing=true;function ruleSorter(a,b)
