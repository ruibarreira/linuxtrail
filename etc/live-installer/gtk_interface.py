...
from utils import shell_exec, getoutput, get_config_dict
import partitioning
...
class InstallerWindow:
    ...
    def __init__(self, fullscreen=False):
        ...
        self.wizard_pages[self.PAGE_INSTALL] = WizardPage(_("Installing Linux Mint..."), "install.svg")
        ...
        multimedia_check.set_active(True)
    ...
    def i18n(self):
        ...
        if not os.path.exists('/bin/plymouth'):
            self.wTree.get_widget("frmPlymouth").set_visible(False)
        else:
    ...
    def assign_on_internet_connection(self):
        if hasInternetConnection():
            self.wTree.get_widget("checkbutton_multimedia").set_active(True)
            ...
            self.setup.multimedia_enable = True
        else:
